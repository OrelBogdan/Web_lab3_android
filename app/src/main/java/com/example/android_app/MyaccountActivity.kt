...
import com.example.android_app.backendapi.RetrofitAuthHelper
...
//        fetchUserDetails(apiService)
        ...
        apiService = RetrofitAuthHelper.getInstance("http://10.0.2.2:8000/", tokenString).create(UserApi::class.java)
