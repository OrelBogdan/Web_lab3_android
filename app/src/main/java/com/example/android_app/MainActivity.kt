...
import com.example.android_app.backendapi.DjangoApi
import com.example.android_app.backendapi.RetrofitHelper
import com.example.android_app.models.LogInBody
import com.example.android_app.models.Token
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
            ...
            djangoApi.getToken(loginInfo).enqueue(object : Callback<Token> {
                ...
                override fun onResponse(call: Call<Token>, response: Response<Token>) {
                    if (response.isSuccessful && response.body() != null) {
                        ...
                        // Navigate to MyaccountActivity if token is received
        ...
        emailEditText.setText("User1@mail.com");
